      ...
      <section id="experiencia" style={{ padding: "6rem clamp(1.5rem, 5vw, 6rem)", maxWidth: "1100px", margin: "0 auto" }}>
        <Reveal>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2rem", fontWeight: "300", letterSpacing: "-0.02em" }}>Experiencia</h2>
        ...
        <div style={{ position: "relative", paddingLeft: "2rem" }}>
          ...
          {data.experience.map((e, i) => (
            <Reveal key={i} delay={i * 0.08}>
              ...
              >
                <div style={{ position: "absolute", left: "-2.5rem", top: "1.5rem", width: "10px", height: "10px", borderRadius: "50%", background: "#4ade80", border: "2px solid #0a0e1a" }} />
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "8px", marginBottom: "8px" }}>
                  <div>
                    <div style={{ fontSize: "16px", fontWeight: "500", color: "#e8eaf0", marginBottom: "2px" }}>{e.role}</div>
                    <div style={{ fontSize: "13px", color: "#4ade80" }}>{e.company}</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: "12px", color: "rgba(232,234,240,0.4)", fontFamily: "'Space Mono', monospace" }}>{e.period}</div>
                    <div style={{ fontSize: "11px", color: "rgba(232,234,240,0.3)", marginTop: "2px" }}>{e.duration}</div>
                  </div>
                </div>
                <p style={{ fontSize: "14px", color: "rgba(232,234,240,0.6)", lineHeight: 1.65, marginBottom: "12px", fontWeight: "300" }}>{e.desc}</p>
      ...
      <section id="formacion" style={{ padding: "4rem clamp(1.5rem, 5vw, 6rem) 6rem", maxWidth: "1100px", margin: "0 auto" }}>
        <Reveal>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2rem", fontWeight: "300", letterSpacing: "-0.02em" }}>Formación</h2>
            <div style={{ flex: 1, height: "1px", background: "rgba(232,234,240,0.08)" }} />
          </div>
        </Reveal>
          ...
          {data.education.map((ed, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div style={{
                ...
                <div style={{ fontSize: "22px", marginBottom: "12px" }}>{ed.done ? "🎓" : "⚡"}</div>
                <div style={{ fontSize: "15px", fontWeight: "500", color: "#e8eaf0", marginBottom: "6px" }}>{ed.title}</div>
                <div style={{ fontSize: "13px", color: "rgba(232,234,240,0.5)", marginBottom: "12px", fontWeight: "300" }}>{ed.sub}</div>
      ...
      <section id="habilidades" style={{ padding: "4rem clamp(1.5rem, 5vw, 6rem) 6rem", maxWidth: "1100px", margin: "0 auto" }}>
        <Reveal>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2rem", fontWeight: "300", letterSpacing: "-0.02em" }}>Habilidades</h2>
            <div style={{ flex: 1, height: "1px", background: "rgba(232,234,240,0.08)" }} />
          </div>
        </Reveal>
        ...
        <Reveal>
          <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "1.5rem", marginBottom: "1.5rem" }}>
            <div style={{ fontSize: "13px", fontWeight: "500", color: "rgba(232,234,240,0.5)", marginBottom: "1.2rem", textTransform: "uppercase", letterSpacing: "0.08em" }}>Idiomas</div>
            {data.languages.map((l, i) => (
              <div key={i} style={{ marginBottom: i < data.languages.length - 1 ? "1rem" : 0 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
                  ...
                  <span style={{ fontSize: "12px", color: "rgba(232,234,240,0.4)", fontFamily: "'Space Mono', monospace" }}>{l.level}</span>
                </div>
                <div style={{ height: "3px", background: "rgba(255,255,255,0.06)", borderRadius: "2px" }}>
                  <div style={{ height: "3px", width: `${l.pct}%`, background: "linear-gradient(90deg, #4ade80, #60a5fa)", borderRadius: "2px", transition: "width 1s ease" }} />
                </div>
              </div>
            ))}
          </div>
        ...
        <Reveal>
          <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "1.5rem" }}>
            <div style={{ fontSize: "13px", fontWeight: "500", color: "rgba(232,234,240,0.5)", marginBottom: "1rem", textTransform: "uppercase", letterSpacing: "0.08em" }}>Competencias personales</div>
      ...
      <section id="contacto" style={{ padding: "4rem clamp(1.5rem, 5vw, 6rem) 8rem", maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
        <Reveal>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2rem", fontWeight: "300", letterSpacing: "-0.02em" }}>Contacto</h2>
            <div style={{ flex: 1, height: "1px", background: "rgba(232,234,240,0.08)" }} />
          </div>
        </Reveal>
        <Reveal delay={0.1}>
          <p style={{ fontSize: "16px", color: "rgba(232,234,240,0.5)", marginBottom: "3rem", fontWeight: "300", lineHeight: 1.7 }}>
